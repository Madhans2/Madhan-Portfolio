...
const Loader = () => {
  return (
    <div className="w-full h-screen fixed top-0 left-0 z-10 bg-zinc-900 flex justify-center items-center">
      <div className="w-full max-w-md text-center">
        ...
        <div className="w-full mt-4 font-bold text-white translate-x-1">Loading...</div>
      </div>
    </div>
  );
};
