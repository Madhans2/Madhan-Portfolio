...
const Loader = () => {
  return (
    <div className="w-full h-screen fixed top-0 left-0 z-50 bg-zinc-900 flex justify-center items-center px-4">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="w-full mt-4 font-semibold text-white text-lg sm:text-xl translate-x-1">
          Loading...
        </div>
      </div>
    </div>
